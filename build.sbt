...
lazy val `sbt-izumi` = (project in file("sbt/sbt-izumi"))
  .settings(
    ...
    libraryDependencies ++= Seq(
      ...
      ("org.xerial.sbt" % "sbt-sonatype" % "3.12.0").extra(SbtVersionKey -> (pluginCrossBuild / sbtBinaryVersion).value, ScalaVersionKey -> (update / scalaBinaryVersion).value).withCrossVersion(Disabled()),
